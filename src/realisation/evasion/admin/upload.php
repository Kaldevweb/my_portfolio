...

                         {
...

                              {
...

                                   {
                                        ...
                                        $req_upload = $bdd->query("INSERT INTO article_destination VALUES('','$new_article_titre','$new_article_description','$new_article_source', '$fichier', '$new_article_pays')") or die($bdd->error);
