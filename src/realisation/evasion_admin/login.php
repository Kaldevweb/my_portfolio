...
<div id="container_login">
	...
	<div id="login">
		...
		<form action="validation.php" method="post" name="form">
			<input type="text" placeholder="Veuillez entrer le nom : test_user" id="username" name="uti"></input><br />
			<input type="password" placeholder="Le mot de pass est : test_pass" name="pw"></input><br />
