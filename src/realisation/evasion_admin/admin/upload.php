          ...
          <?php
               ...
               else
               {
                    ...
                    if(autorisation($_SESSION["uti"],$_SESSION["pw"]))
                    {
                         ...
                         @$new_article_titre=$_POST["new_article_titre"];
                         //@$new_article_titre=$_POST["new_article_titre"];
                         $new_article_titre = $bdd -> real_escape_string($new_article_titre);

                         @$new_article_description=$_POST["new_article_description"];
                         //@$new_article_description=$_POST["new_article_description"];
                         $new_article_description = $bdd -> real_escape_string($new_article_description);

                         @$new_article_source=$_POST["new_article_source"];
                         //@$new_article_source=$_POST["new_article_source"];
                         $new_article_source = $bdd -> real_escape_string($new_article_source);


                         @$new_article_pays=$_POST["new_article_pays"];
...

                         {
...

                              {
...

                                   {
                                        ...
                                        $req_upload = $bdd->query("INSERT INTO evasion_admin_article_destination VALUES('','$new_article_titre','$new_article_description','$new_article_source', '$fichier', '$new_article_pays')") or die($bdd->error);
                                        // $req_upload = $bdd->query("INSERT INTO article_destination VALUES('','$new_article_titre','$new_article_description','$new_article_source', '$fichier', '')") or die($bdd->errno);
